...
from packaging._vendor import boolean
from packaging._vendor.boolean import Expression as LicenseExpression

# note these may not all be used here but are imported here to avoid leaking
# boolean.py constants to callers
from packaging._vendor.boolean.boolean import PARSE_ERRORS
from packaging._vendor.boolean.boolean import PARSE_INVALID_EXPRESSION
from packaging._vendor.boolean.boolean import PARSE_INVALID_NESTING
from packaging._vendor.boolean.boolean import PARSE_INVALID_OPERATOR_SEQUENCE
from packaging._vendor.boolean.boolean import PARSE_INVALID_SYMBOL_SEQUENCE
from packaging._vendor.boolean.boolean import PARSE_UNBALANCED_CLOSING_PARENS
from packaging._vendor.boolean.boolean import PARSE_UNKNOWN_TOKEN

from packaging._vendor.boolean.boolean import ParseError
from packaging._vendor.boolean.boolean import TOKEN_SYMBOL
from packaging._vendor.boolean.boolean import TOKEN_AND
from packaging._vendor.boolean.boolean import TOKEN_OR
from packaging._vendor.boolean.boolean import TOKEN_LPAR
from packaging._vendor.boolean.boolean import TOKEN_RPAR

from packaging._vendor.license_expression._pyahocorasick import Trie as AdvancedTokenizer
from packaging._vendor.license_expression._pyahocorasick import Token

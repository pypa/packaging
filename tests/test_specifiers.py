    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            for v, s in [
                ...
                ("2.post1.dev1", "==2.0.post1.*"),
                ("2.0.post1.dev1", "==2.post1.*"),
                ("2.0.rc1", "==2.0.c1.*"),
                ("2.0.rc1.post1", "==2.0.c1.*"),
                ("2rc1", "==2.0c1.*"),
                ("2.0rc1", "==2c1.*"),
                ("2.0rc1.post1.dev1", "==2.0c1.*"),
                ("2rc1.post1.dev1", "==2.0c1.*"),
                ("2.0rc1.post1.dev1", "==2c1.*"),
                ("2.0rc1.post0", "==2.0c1.post.*"),
                ("2rc1.post0", "==2.0c1.post.*"),
                ("2.0rc1.post0", "==2c1.post.*"),
                ("2.0rc1.post0.dev1", "==2.0c1.post.*"),
                ("2rc1.post0.dev1", "==2.0c1.post.*"),
                ("2.0rc1.post0.dev1", "==2c1.post.*"),
